...
const Resume = () => {
  ...
  return (
    <>
      <motion.div initial={{opacity:0}} whileInView={{opacity:1}} transition={{duration:2}} viewport={{once:true}} className="w-[100%] bg-gray-50 resume-container p-12 max-md:p-4 max-sm:p-2 relative">
